...
@app.route('/api/notification/SomeRoute', methods=['GET'])
@app.route('/api/notification/SomeRoute', methods=['POST'])
@app.route('/api/notification/SomeRoute', methods=['PUT'])
@app.route('/api/notification/SomeRoute', methods=['DELETE'])
def SomeFunctionality():
	response={}
	logger(request,response)
	return "<h1>notification service %s</H1>"%(rand)

@app.route('/api/notification/OtherRoute', methods=['POST'])
